...
import { UserIcon, CreditCardIcon, HomeIcon, LockIcon, HelpCircleIcon, LogOutIcon } from "lucide-react";
    ...
    <div className="slide-in px-4 pt-4">
      ...
      <Card className="mb-4">
        <CardContent className="p-4 flex items-center">
          ...
          <div>
            <h3 className="font-semibold text-lg">{isLoading ? "Loading..." : username}</h3>
            <p className="text-gray-500">
              {isLoading ? "Loading..." : user?.username || "user@example.com"}
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="space-y-1">
            ...
            <Button variant="ghost" className="w-full justify-start py-6 text-red-500">
