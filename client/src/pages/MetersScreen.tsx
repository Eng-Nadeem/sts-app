	...
	return (
		<div className="slide-in px-4 pt-4 pb-8">
			<div className="flex items-center justify-between mb-5">
				<h2 className="text-xl font-semibold">العدادات الخاصة بي</h2>
							...
							<CardHeader className="p-4 pb-2">
								<div className="flex justify-between items-start">
									<CardTitle className="text-base font-medium">
										{meter.nickname ||
											`Meter ${meter.meterNumber.substring(
												0,
												5
											)}...`}
									</CardTitle>
			...
			<Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
				<DialogContent>
					...
					<Form {...addForm}>
						<form
							onSubmit={addForm.handleSubmit(handleAddMeter)}
							className="space-y-4">
							<FormField
			...
			<Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
				<DialogContent>
					...
					<Form {...editForm}>
						<form
							onSubmit={editForm.handleSubmit(handleUpdateMeter)}
							className="space-y-4">
							<FormField
