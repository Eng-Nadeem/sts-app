...
const ErrorScreen = () => {
	...
	const handleTryAgain = () => {
		navigate(
			`/payment-confirmation?meterNumber=${meterNumber}&amount=${amount}`
		);
	};
	...
	return (
		<div className="slide-in h-full flex items-center justify-center">
			<div className="text-center px-4">
				...
				<h2 className="text-xl font-semibold mb-2">فشلت المعاملة</h2>
				<p className="text-gray-500 mb-6">لم نتمكن من إكمال دفعك</p>

				<Card className="mb-6 mx-auto max-w-xs">
					<CardContent className="p-4">
						<div className="flex justify-between mb-2">
							<span className="text-gray-500">رمز الخطأ:</span>
				...
				<p className="text-sm text-gray-500 mb-6">
					لم يتم خصم أي مبلغ من حسابك. الرجاء المحاولة مرة أخرى أو
					الاتصال بدعم العملاء إذا استمرت المشكلة.
				</p>
